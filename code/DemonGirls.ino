...
//        gb.display.drawImage(64, 0 - bigDemon*2, theGreatFly);
        gb.display.drawImage(bigDemon*4 + 64, 0, theGreatFly);

/*
//        gb.display.drawImage(bigDemon*4 + 32, 0, theGreatFly96x32);
//        gb.display.drawImage(32, 0 + bigDemon*2, leftClaws);
        gb.display.drawImage(40, 0 + bigDemon*2, leftClaws);
        gb.display.drawImage(96, 0 + bigDemon*2, rightClaws);
        gb.display.drawImage(0, 0 - bigDemon*2, leftWing);
//        gb.display.drawImage(128, 0 - bigDemon*2, rightWing);
        gb.display.drawImage(120, 0 - bigDemon*2, rightWing);
*/
...
//          gb.display.drawImage(bigDemon*4 + 64, 0, heroRight, 32, 32);
          gb.display.drawImage(bigDemon*4 + 64, 0, bigHeroRight);
        } else {
//          gb.display.drawImage(bigDemon*4 + 64, 0, heroNippleRight, 32, 32);
          gb.display.drawImage(bigDemon*4 + 64, 0, bigHeroNipple);
        }
      }
      break;
    case 1:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Pandemonica, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigPandemonica);
      break;
    case 2:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Modeus, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigModeus);
      break;
    case 3:
...
//      gb.display.drawImage(bigDemon*4 + 96, 0, Cerberus, 32, 32);
      gb.display.drawImage(bigDemon*4 + 32, 0, bigCerberus);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigCerberus);
      gb.display.drawImage(bigDemon*4 + 96, 0, bigCerberus);
      break;
    case 4:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Malina, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigMalina);
      break;
    case 5:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Zdrada, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigZdrada);
      break;
    case 6:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Azazel, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigAzazel);
      break;
    case 7:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Justice, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigJustice);
      break;
    case 8:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Lucifer, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigLucifer);
      if(answered < 5) {
//        gb.display.drawImage(bigDemon*4 + 32, 0, SkeletonStill, 32, 32);
        gb.display.drawImage(bigDemon*4 + 32, 0, bigSkeletonLeft);
//        gb.display.drawImage(bigDemon*4 + 96, 0, SkeletonStill, -32, 32);
        gb.display.drawImage(bigDemon*4 + 96, 0, bigSkeletonRight);
      } else {
//        gb.display.drawImage(bigDemon*4 + 32, 0, SkeletonLove, 32, 32);
        gb.display.drawImage(bigDemon*4 + 32, 0, bigSkeletonLoveLeft);
//        gb.display.drawImage(bigDemon*4 + 96, 0, SkeletonLove, -32, 32);
        gb.display.drawImage(bigDemon*4 + 96, 0, bigSkeletonLoveRight);
      }
      break;
    case 9:
//      gb.display.drawImage(bigDemon*4 + 64, 0, Judgement, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigJudgement);
      break;
    case 10:
 //     gb.display.drawImage(bigDemon*4 + 64, 0, Beelzebub, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigBeelzebub);
      break;
  }
}
...
//      gb.display.print(" It's no time to sleep! A\n");
      gb.display.print("  It's no time to sleep!\n");
      gb.display.setCursorX(5);
//      gb.display.print(" lot of work is still to\n");
      gb.display.print(" There is still a lot of\n");
      gb.display.setCursorX(2);
//      gb.display.print("         be done.");
      gb.display.print("     work to be done.");
    }
    break; 
  }
}
...
//      gb.display.drawImage(bigDemon*4 + 64, 0, Goddess, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, Captain);
    }
    if((answered > 4) && (answered < 7)) {
//      gb.display.drawImage(bigDemon*4 + 64, 0, yogurt, 32, 32);
      gb.display.drawImage(bigDemon*4 + 64, 0, bigYogurt);
    }
    if(answered > 6) {
      if(slipMode == false) {
//        gb.display.drawImage(bigDemon*4 + 64, 0, heroRight, 32, 32);
...
void harem() {
  ...
  switch (haremCounter) {
    case 0:
      ...
      gb.display.drawImage(128 + xHarem, 48, bigPandemonica);
      gb.display.drawImage(192 + xHarem, 48, bigModeus);
    break;
    case 1:
      gb.display.drawImage(128 + xHarem, 48, bigModeus);
      gb.display.drawImage(192 + xHarem, 48, bigCerberus);
    break;
    case 2:
      gb.display.drawImage(128 + xHarem, 48, bigCerberus);
      gb.display.drawImage(192 + xHarem, 48, bigCerberus);
    break;
    case 3:
      gb.display.drawImage(128 + xHarem, 48, bigCerberus);
    ...
    case 4:
      gb.display.drawImage(128 + xHarem, 48, bigCerberus);
      gb.display.drawImage(192 + xHarem, 48, bigMalina);
    break;
    case 5:
      gb.display.drawImage(128 + xHarem, 48, bigMalina);
      gb.display.drawImage(192 + xHarem, 48, bigZdrada);
    break;
    case 6:
      gb.display.drawImage(128 + xHarem, 48, bigZdrada);
      gb.display.drawImage(192 + xHarem, 48, bigAzazel);
    break;
    case 7:
      gb.display.drawImage(128 + xHarem, 48, bigAzazel);
      gb.display.drawImage(192 + xHarem, 48, bigJustice);
    break;
    case 8:
      gb.display.drawImage(128 + xHarem, 48, bigJustice);
      gb.display.drawImage(192 + xHarem, 48, bigLucifer);
    break;
    case 9:
      gb.display.drawImage(128 + xHarem, 48, bigLucifer);
      gb.display.drawImage(192 + xHarem, 48, bigJudgement);
    break;
    case 10:
      gb.display.drawImage(128 + xHarem, 48, bigJudgement);
      gb.display.drawImage(192 + xHarem, 48, bigBeelzebub);
    break;
    case 11:
      gb.display.drawImage(128 + xHarem, 48, bigBeelzebub);
      if(slipMode == false) {
        gb.display.drawImage(192 + xHarem, 48, bigHeroRight);
      } else {
        gb.display.drawImage(192 + xHarem, 48, bigHeroNipple);
      }
    break;
    case 12:
      if(slipMode == false) {
        gb.display.drawImage(128 + xHarem, 48, bigHeroRight);
      } else {
        gb.display.drawImage(128 + xHarem, 48, bigHeroNipple);
      }
    break;  
  }
